...
const StyledWrapper = styled(Box)({
    position: 'relative',
    background: 'linear-gradient(112.77deg, rgb(32, 0, 65) 14.65%, rgb(140, 98, 255) 87.93%)',
    padding: '16px 24px',
    borderRadius: '16px',
});
    ...
    return (
        <StyledWrapper>
            ...
            <Grid container spacing={5}>
                <Grid item xs={6} md={6}>
                    <Box>
                        <StyledText>{numberFormat(state.spotBalance?.demoBalance)}</StyledText>
                        <StyledSubText>{t('demo_wallet')}</StyledSubText>
                    </Box>
                </Grid>
...
export default CardAccountDemo;
